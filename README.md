...
├── Style1.css              # Secondary styles
├── Script.js               # JavaScript logic
├── ProcessForm.php         # Form submission handler
│
├── Course1.html            # Course detail pages
├── Course2.html
├── Course3.html
├── Course4.html
├── Course5.html
...
# For PHP form to work, use a local server:
